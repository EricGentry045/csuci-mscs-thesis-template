...
\begin{enumerate}
  ...
  For example: If setting up three SEAKER environments, configuration could be:
    ...
    \end{enumerate}
  \item Insert micro SD card into computer (not the Raspberry Pi).
  ...
  \item Insert the card into the Raspberry Pi.
...
\begin{figure}[ht]
  ...
  \caption{iPhone WIFI connection to the SEAKER.}\label{fig:screen-1}
  \end{center}
\end{figure}
