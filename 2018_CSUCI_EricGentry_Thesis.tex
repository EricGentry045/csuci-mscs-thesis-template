...
Contributions I have made to the \gls{seaker} device project:
\begin{enumerate}
  \item Developed the \gls{seaker} creation bash script to turn a standard \gls{rpi} into a
  \gls{seaker} by programmatically
  ...
  \item Presented \gls{seaker} as a thesis project at the April 2018 CSUCI Cyber Security Event to CSUCI President
  ...
  \item Updated and enhanced \gls{seaker} functionality to support the latest raspbian operating system (Stretch
